...
ENV DROPBOX_SYNC_INTERVAL_SECONDS=1800
...
ENV OCR_DETECTION_DEBUG=false
ENV OCR_DETECTION_METADATA_KEEP_NEW_LINES=false
ENV OCR_DETECTION_TEXT_STRATEGY=TEXTS
ENV OCR_DETECTION_TEXT_EXTRACT_STRATEGY=TEXTS
ENV OCR_DPI=300
